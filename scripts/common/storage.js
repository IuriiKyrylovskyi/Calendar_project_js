  ...
  events: [
    {
      ...
      start: new Date('2021-02-25T01:10:00.000Z'),
      end: new Date('2021-02-25T04:30:00.000Z'),
    },
    {
      id: 0.7520027086457111, // id понадобится для работы с событиями
      title: 'Eat',
      description: 'something',
      start: new Date('2021-02-22T05:45:00.000Z'),
      end: new Date('2021-02-22T18:30:00.000Z'),
    },
    {
      id: 0.7520027086457999, // id понадобится для работы с событиями
      title: 'Old',
      description: 'task',
      start: new Date('2021-01-20T04:38:00.000Z'),
      end: new Date('2021-01-20T05:37:00.000Z'),
    },
  ],
